...
public interface VideoSearchClient {
    ...
    */
     ...
     * @return the service client itself
     */
    VideoSearchClient withAcceptLanguage(String acceptLanguage);
     ...
     * @return the service client itself
     */
    VideoSearchClient withLongRunningOperationRetryTimeout(int longRunningOperationRetryTimeout);
     ...
     * @return the service client itself
     */
    VideoSearchClient withGenerateClientRequestId(boolean generateClientRequestId);
