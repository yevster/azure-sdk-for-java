...
public interface TextAnalyticsClient {
    ...
    */
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<LanguageBatchResult> detectLanguageAsync(Boolean showStats, List<LanguageInput> documents, final ServiceCallback<LanguageBatchResult> serviceCallback);
     ...
     * @return the observable to the LanguageBatchResult object
     */
    Observable<LanguageBatchResult> detectLanguageAsync(Boolean showStats, List<LanguageInput> documents);
     ...
     * @return the observable to the LanguageBatchResult object
     */
    Observable<ServiceResponse<LanguageBatchResult>> detectLanguageWithServiceResponseAsync(Boolean showStats, List<LanguageInput> documents);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<EntitiesBatchResult> entitiesAsync(Boolean showStats, List<MultiLanguageInput> documents, final ServiceCallback<EntitiesBatchResult> serviceCallback);
     ...
     * @return the observable to the EntitiesBatchResult object
     */
    Observable<EntitiesBatchResult> entitiesAsync(Boolean showStats, List<MultiLanguageInput> documents);
     ...
     * @return the observable to the EntitiesBatchResult object
     */
    Observable<ServiceResponse<EntitiesBatchResult>> entitiesWithServiceResponseAsync(Boolean showStats, List<MultiLanguageInput> documents);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<KeyPhraseBatchResult> keyPhrasesAsync(Boolean showStats, List<MultiLanguageInput> documents, final ServiceCallback<KeyPhraseBatchResult> serviceCallback);
     ...
     * @return the observable to the KeyPhraseBatchResult object
     */
    Observable<KeyPhraseBatchResult> keyPhrasesAsync(Boolean showStats, List<MultiLanguageInput> documents);
     ...
     * @return the observable to the KeyPhraseBatchResult object
     */
    Observable<ServiceResponse<KeyPhraseBatchResult>> keyPhrasesWithServiceResponseAsync(Boolean showStats, List<MultiLanguageInput> documents);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Object> sentimentAsync(final ServiceCallback<Object> serviceCallback);
     ...
     */
    Observable<Object> sentimentAsync();
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> sentimentWithServiceResponseAsync();
    /**
     * The API returns a numeric score between 0 and 1.
     * Scores close to 1 indicate positive sentiment, while scores close to 0 indicate negative sentiment. A score of 0.5 indicates the lack of sentiment (e.g. a factoid statement). See the &lt;a href="https://docs.microsoft.com/en-us/azure/cognitive-services/text-analytics/overview#supported-languages"&gt;Text Analytics Documentation&lt;/a&gt; for details about the languages that are supported by sentiment analysis.
     *
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Object> sentimentAsync(Boolean showStats, List<MultiLanguageInput> documents, final ServiceCallback<Object> serviceCallback);
     ...
     * @return the observable to the Object object
     */
    Observable<Object> sentimentAsync(Boolean showStats, List<MultiLanguageInput> documents);
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> sentimentWithServiceResponseAsync(Boolean showStats, List<MultiLanguageInput> documents);
