...
/**
 * Initializes a new instance of the SpellCheckClientImpl class.
 */
public class SpellCheckClientImpl extends AzureServiceClient implements SpellCheckClient {
     ...
     * @return the service client itself
     */
    public SpellCheckClientImpl withAcceptLanguage(String acceptLanguage) {
     ...
     * @return the service client itself
     */
    public SpellCheckClientImpl withLongRunningOperationRetryTimeout(int longRunningOperationRetryTimeout) {
     ...
     * @return the service client itself
     */
    public SpellCheckClientImpl withGenerateClientRequestId(boolean generateClientRequestId) {
     ...
     */
    public SpellCheckClientImpl(ServiceClientCredentials credentials) {
     ...
     * @param credentials the management credentials for Azure
     */
    private SpellCheckClientImpl(String baseUrl, ServiceClientCredentials credentials) {
     ...
     */
    public SpellCheckClientImpl(RestClient restClient) {
        super(restClient);
        initialize();
    }
     ...
     */
    public SpellCheck spellChecker(String text) {
        return spellCheckerWithServiceResponseAsync(text).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<SpellCheck> spellCheckerAsync(String text, final ServiceCallback<SpellCheck> serviceCallback) {
        return ServiceFuture.fromResponse(spellCheckerWithServiceResponseAsync(text), serviceCallback);
    }
     ...
     * @return the observable to the SpellCheck object
     */
    public Observable<ServiceResponse<SpellCheck>> spellCheckerWithServiceResponseAsync(String text) {
        ...
        return service.spellChecker(xBingApisSDK, acceptLanguage, pragma, userAgent, clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText, text, parameterizedHost, this.userAgent())
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SpellCheck> spellCheckerAsync(String text, String acceptLanguage, String pragma, String userAgent, String clientId, String clientIp, String location, ActionType actionType, String appName, String countryCode, String clientMachineName, String docId, String market, String sessionId, String setLang, String userId, String mode, String preContextText, String postContextText, final ServiceCallback<SpellCheck> serviceCallback) {
        return ServiceFuture.fromResponse(spellCheckerWithServiceResponseAsync(text, acceptLanguage, pragma, userAgent, clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText), serviceCallback);
    }
