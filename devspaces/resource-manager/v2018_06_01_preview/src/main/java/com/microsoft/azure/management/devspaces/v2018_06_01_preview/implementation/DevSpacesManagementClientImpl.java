...
public class DevSpacesManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The ContainerHostMappingsInner object to access its operations.
     */
    private ContainerHostMappingsInner containerHostMappings;

    /**
     * Gets the ContainerHostMappingsInner object to access its operations.
     * @return the ContainerHostMappingsInner object.
     */
    public ContainerHostMappingsInner containerHostMappings() {
    ...
    protected void initialize() {
        ...
        this.containerHostMappings = new ContainerHostMappingsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "DevSpacesManagementClient", "2018-06-01-preview");
    }
}
